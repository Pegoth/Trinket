var trinkets = {
  ...
  "Augury of the Primal Flame": {
    ...
    "Protection Warrior": {
      "tier": "S",
      "note": "Very strong damage proc trinket. Effortless to use, deals a lot of damage. No downsides. It’s free real estate."
    }
  },
  "Fyrakk's Tainted Rageheart": {
    ...
    "Protection Warrior": {
      "tier": "S",
      "note": "The best tank trinket Blizzard has made in some time. It shields you and causes you to radiate a large chunk of damage to nearby enemies. The shield is pretty good, the 90-second cooldown is relatively brief, and the damage is respectable for a trinket that also has tangible defensive benefits. It’s good."
    }
  },
  "Pip's Emerald Friendship Badge": {
    ...
    "Brewmaster Monk": {
      "tier": "A-",
      "note": "A cute name and trinket idea. Everyone needs a best friend!Practically speaking, this is just a stat proc trinket that alternates between Crit, Versatility, and Mastery. It’s not amazing, but it’s not bad, either. It is slightly overbudget, which is great! It's decent!"
    },
    "Mistweaver Monk": {
      "tier": "A",
    ...
    "Protection Warrior": {
      "tier": "B+",
      "note": "A cute name and trinket idea. Everyone needs a best friend!Practically speaking, this is just a stat proc trinket that alternates between Crit, Versatility, and Mastery, and it is overbudget for its item level. The lack of Haste is not ideal. It’s not amazing, but it’s not bad, either. Above average! Decent!"
    }
  },
  ...
  "Spores of Alacrity": {
    ...
    "Protection Warrior": {
      "tier": "B-",
      "note": "Strength trinket with a Haste on-use effect. It’s pretty simple, and it’s okay."
    }
  },
  "Nightmare Egg Shell": {
    "Blood Death Knight": {
  ...
  "Might of the Ocean": {
    ...
    "Protection Warrior": {
      "tier": "B-",
      "note": "It's a 2-minute cooldown, on-use stat trinket that grants a lot of Strength. It’s okay."
    }
  },
  "Porcelain Crab": {
    "Blood Death Knight": {
  ...
  "Spiked Counterweight": {
    ...
    "Brewmaster Monk": {
      "tier": "C-",
      "note": "Passive Haste and a moderate single-target damage proc with a fairly low procrate. It’s bad."
    },
    "Protection Paladin": {
      "tier": "B+",
  ...
  "Ashes of the Embersoul": {
    ...
    "Brewmaster Monk": {
      "tier": "C+",
      "note": "A Haste trinket with an Agility on-use effect. It’s very bad for Monks."
    },
    "Protection Paladin": {
      "tier": "D",
    ...
    "Protection Warrior": {
      "tier": "B+",
      "note": "A Haste trinket with a Strength on-use effect. It’s interesting, but the 1-minute anti-Haste debuff makes it effectively equivalent to not wearing a trinket half of the time. That kinda sucks!"
    }
  },
  "Caged Horror": {
    "Blood Death Knight": {
  ...
  "Mirror of Fractured Tomorrows": {
    ...
    "Survival Hunter": {
      "tier": "A",
      "note": "A very powerful on-use that does damage as well as increases your highest secondary—usually critical strike or haste. Added bonus of lining up with every other Spearhead!"
    },
    "Arcane Mage": {
      "tier": "A+",
  ...
  "Bandolier of Twisted Blades": {
    ...
    "Brewmaster Monk": {
      "tier": "A+",
      "note": "On-use damage trinket. It deals damage to the primary target, then boomerangs a blade from them to you, splitting damage with every enemy along the way. It’s not complicated, and the damage is good."
    },
    "Assassination Rogue": {
      "tier": "A-",
